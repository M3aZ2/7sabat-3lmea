...
class Meteor{
    ...
    )
    {
        ...
        this.velocity = this.toVector(speed,-1);
    ...
    centrifugalForce() {                                // Centrigugal Force
                                                        // F = m * ω² * r
